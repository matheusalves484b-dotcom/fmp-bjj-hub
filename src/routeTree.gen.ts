...
export interface FileRoutesByFullPath { '/': typeof IndexRoute; '/login': typeof LoginRoute; '/alunos': typeof AlunosRoute; '/turmas': typeof TurmasRoute; '/frequencia': typeof FrequenciaRoute; '/minhas-aulas': typeof MinhasAulasRoute }
export interface FileRoutesByTo { '/': typeof IndexRoute; '/login': typeof LoginRoute; '/alunos': typeof AlunosRoute; '/turmas': typeof TurmasRoute; '/frequencia': typeof FrequenciaRoute; '/minhas-aulas': typeof MinhasAulasRoute }
export interface FileRoutesById { __root__: typeof rootRouteImport; '/': typeof IndexRoute; '/login': typeof LoginRoute; '/alunos': typeof AlunosRoute; '/turmas': typeof TurmasRoute; '/frequencia': typeof FrequenciaRoute; '/minhas-aulas': typeof MinhasAulasRoute }
export interface FileRouteTypes { fileRoutesByFullPath: FileRoutesByFullPath; fullPaths: '/' | '/login' | '/alunos' | '/turmas' | '/frequencia' | '/minhas-aulas'; fileRoutesByTo: FileRoutesByTo; id: '__root__' | '/' | '/login' | '/alunos' | '/turmas' | '/frequencia' | '/minhas-aulas'; fileRoutesById: FileRoutesById }
export interface RootRouteChildren { IndexRoute: typeof IndexRoute; LoginRoute: typeof LoginRoute; AlunosRoute: typeof AlunosRoute; TurmasRoute: typeof TurmasRoute; FrequenciaRoute: typeof FrequenciaRoute; MinhasAulasRoute: typeof MinhasAulasRoute }
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, LoginRoute, AlunosRoute, TurmasRoute, FrequenciaRoute, MinhasAulasRoute }
